...
# Binary
install_name_tool -change /usr/local/lib/libGLEW.1.11.0.dylib @executable_path/libGLEW.1.11.0.dylib ${BINARY}
...
install_name_tool -change /usr/local/Cellar/libvorbis/1.3.4/lib/libvorbis.0.dylib @executable_path/libvorbis.0.dylib libvorbisfile.dylib
...
install_name_tool -change /usr/local/Cellar/libvorbis/1.3.4/lib/libvorbis.0.dylib @executable_path/libvorbis.0.dylib libvorbisfile.3.dylib
